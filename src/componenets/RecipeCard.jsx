...
const RecipeCard = (props) => {
  const { id, image, instructions, name, chef } = props.recipe;
  ...
  return (
    ...
    >
      <Link
        ...
        className="block w-full bg-slate-900/80 border border-slate-700 p-4 rounded-2xl shadow-lg hover:border-orange-500/50 transition-colors h-full"
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex flex-col gap-2 flex-1">
            <h2 className="font-semibold tracking-tight text-xl sm:text-2xl line-clamp-2">{name}</h2>
